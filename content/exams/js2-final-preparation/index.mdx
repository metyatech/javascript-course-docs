...
| criterionId      | points | description                            | gradingMode |
| ---------------- | ------ | -------------------------------------- | ----------- |
| q3.menu.get      | 3      | メニュー要素を取得できている           | manual      |
| q3.submenu.get   | 3      | サブメニュー要素を取得できている       | manual      |
| q3.event.enter   | 5      | マウスエンターイベントを設定している   | manual      |
| q3.event.leave   | 5      | マウスリーブイベントを設定している     | manual      |
| q3.class.add     | 4      | クラスを追加する記述がある             | manual      |
| q3.class.remove  | 4      | クラスを削除する記述がある             | manual      |
| q3.requirement   | 2      | 要件通り動作する                       | manual      |
...
| criterionId     | points | description                          | gradingMode |
| --------------- | ------ | ------------------------------------ | ----------- |
| q4.fill1        | 4      | 1つ目の穴埋めが正答                  | fill        |
| q4.fill2        | 4      | 2つ目の穴埋めが正答                  | fill        |
| q4.fill3        | 4      | 3つ目の穴埋めが正答                  | fill        |
| q4.fill4        | 4      | 4つ目の穴埋めが正答                  | fill        |
| q4.fill5        | 4      | 5つ目の穴埋めが正答                  | fill        |
