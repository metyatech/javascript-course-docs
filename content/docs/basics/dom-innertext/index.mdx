...
<Hint>
「innerText / 演習1」では、問題文の「body内が 次のようになっているHTMLファイルに対し、 下の薄灰色にハイライトされて…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<ul class="option2">
    ...
    // highlight-next-line
    <li class="item selected">2 - 項目B</li>
    <!-- 中身を「2 - 選択中B」に変更 -->
...
<Hint>
「innerText / 演習1 - 発展」では、問題文の「body内が 次のようになっているHTMLファイルに対し、 下の薄灰色にハイライトされて…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
