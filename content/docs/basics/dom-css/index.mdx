...
<Hint>
「DOM操作とCSS操作 / 演習1」では、問題文の「body内が 次のようになっているHTMLファイルに対して、 下の薄灰色にハイライトされ…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「DOM操作とCSS操作 / 演習1 - 発展」では、問題文の「body内が 次のようになっているHTMLファイルに対し、 下の薄灰色にハイライトされて…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「DOM操作とCSS操作 / 演習2」では、問題文の「body内が 次のようになっているHTMLファイルに対し、 下の薄灰色にハイライトされて…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「DOM操作とCSS操作 / 演習3」では、問題文の「body内が 次のようになっているHTMLファイルに対し、 下の薄灰色にハイライトされて…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `display: none;`、`width: 数値;`、`width: 100px;`、`height: 数値;` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「DOM操作とCSS操作 / 演習3 - 発展」では、問題文の「body内が 次のようになっているHTMLファイルに対して、JavaScriptでCSS…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
