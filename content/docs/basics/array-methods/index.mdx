...
<Exercise title="演習-発展1（配列から要素を取り出して結合）">
...
<Exercise title="演習-発展2（join で文字列にする）">
...
<Exercise title="演習-発展3（数値を昇順にソート）">
...
<Exercise title="演習-発展4（条件位置以降を fill で埋める）">
...
<Exercise title="演習-発展5（ソートとフィルター）">
...
<Exercise title="演習-発展6（検索）">
1. 演習-発展5の `items` に対して、価格が **100 以上** の最初の **飲料** を検索し、そのインデックス、名前、価格を次のように出力せよ。
