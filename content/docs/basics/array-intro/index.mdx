...
<CodePreview>
  ```javascript let schools = ["小学校", "中学校", "高校"];
  console.log(schools); ```
</CodePreview>
...
<CodePreview>
  ```javascript let schools = ["小学校", "中学校", "高校"]; // 読み取り
  console.log(schools[0]); console.log(schools[1]); console.log(schools[2]); //
  書き換え schools[2] = "高等学校"; console.log(schools[2]); ```
</CodePreview>
...
<CodePreview>
  ```javascript let schools = ["小学校", "中学校", "高校"]; // 要素数を出力
