...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習1」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習2」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習3」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習4」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展1（カードのホバーアニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展2（ボタンのアニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展3（テキストの色変化アニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展4（複数プロパティの連動アニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展5（プログレスバーアニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展6（カードめくりアニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `!`、`isFlipped = !isFlipped` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展7（複数カードのフェードインアニメーション）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `querySelectorAll`、`for...of` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「JavaScriptでCSS Transitionを使ったアニメーション / 演習-発展8（画像ギャラリーのズーム効果）」では、問題文の「body内が 次のようになっているHTMLファイルに対し、JavaScriptとCSSで…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `querySelectorAll`、`for...of` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
