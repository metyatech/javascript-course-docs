...
<Hint>
「アコーディオンメニュー (jQuery - slideToggle) / 演習1」では、問題文の「次のHTMLで、h3.PPP をクリックしたら div.QQQ が開閉するようにせよ」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `h3.PPP`、`div.QQQ` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「アコーディオンメニュー (jQuery - slideToggle) / 演習2（＋/− アイコンの切り替え）」では、問題文の「h3.aaa の右側に「＋/−」を表示し、クリックで「＋↔−」と、背景色が状態により切り…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `h3.aaa` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「アコーディオンメニュー (jQuery - slideToggle) / 演習3（開いた回数を表示）」では、問題文の「h3.ccc をクリックして「開いた」時だけ、div.count の「開いた回数」の表示…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `h3.ccc`、`div.count` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「アコーディオンメニュー (jQuery - slideToggle) / 演習3-発展（＋/−を滑らかに切り替え）」では、問題文の「h3.ccc の右側にある「＋」または「−」が、メニューの開閉に合わせて 回転アニメーシ…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `h3.ccc`、`transform`、`transition`、`transform: rotate(角度deg)` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
