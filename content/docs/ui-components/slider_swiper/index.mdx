...
<Hint>
「スライダー (Swiper.js) / 演習1（基本のスライダー：3枚を横にスワイプ）」では、問題文の「3枚のスライドを横にスワイプできる、次のプレビューのようなスライダーを作成して下さい」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「スライダー (Swiper.js) / 演習2（矢印とページネーションを付ける）」では、問題文の「4枚のスライドを横にスワイプできる、次のプレビューのようなスライダーを作成して下さい」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「スライダー (Swiper.js) / 演習2-発展1（自動再生とループ機能）」では、問題文の「5枚のスライドを持つ、次のプレビューのようなスライダーを作成して下さい」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `loop: true`、`autoplay: { delay: 3000 }` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「スライダー (Swiper.js) / 演習2-発展2（複数枚同時表示）」では、問題文の「6枚のスライドを持つ、次のプレビューのようなスライダーを作成して下さい」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `slidesPerView: 3`、`spaceBetween: 20` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
