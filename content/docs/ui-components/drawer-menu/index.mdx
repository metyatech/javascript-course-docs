...
<Hint>
「ドロワーメニュー / 演習1（ヘッダーとハンバーガーアイコンの作成）」では、問題文の「まずは、ヘッダーとハンバーガーアイコンの見た目を作りましょう」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「ドロワーメニュー / 演習2（メニューコンテンツの作成）」では、問題文の「続いて、ドロワーメニューのメニューコンテンツを作りましょう」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
.drawer.open {
    /* メニューコンテンツに open クラスがついているとき（開いているとき） */
...
<Hint>
「ドロワーメニュー / 演習3（開閉機能の作成）」では、問題文の「ついに、JavaScript で開閉機能を作りましょう」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「ドロワーメニュー / 演習4（アニメーション化）」では、問題文の「あとは適切にアニメーションするように調整しましょう」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
.overlay.open {
    /* オーバーレイに open クラスがついているとき（開いているとき） */
    opacity: 1; /* 見えるようにする */
}
```
...
<Hint>
「ドロワーメニュー / 演習-発展1（オーバーレイ）」では、問題文の「以下のプレビューのように、メニューが開いているときは、ページの内容の上にグレーの半透明の…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
.ham-icon.open .line.top {
    /* ハンバーガーアイコンに open クラスがついているとき（開いているとき）　の　一番上の線 */
    transform: rotate(45deg); /* 45度回転 */
}
.ham-icon.open .line.middle {
    /* ハンバーガーアイコンに open クラスがついているとき（開いているとき）　の　真ん中の線 */
    opacity: 0; /* 透明にする */
}
.ham-icon.open .line.bottom {
    /* ハンバーガーアイコンに open クラスがついているとき（開いているとき）　の　一番下の線 */
    transform: rotate(-45deg); /* -45度回転 */
}
...
<Hint>
「ドロワーメニュー / 演習-発展2（ハンバーガーから×アイコンにアニメーション）」では、問題文の「以下のプレビューのように、メニューを開いたときに、ハンバーガーアイコンが×アイコンに変化…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「ドロワーメニュー / 演習-発展3（ハンバーガーアイコンの長さ調整）」では、問題文の「先ほどの演習 発展2では、実は×が綺麗な正方形になっていません」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。特に `.png` がどの値・要素を表すか確認してから書き始めましょう。
</Hint>
...
<Hint>
「ドロワーメニュー / 演習-発展4（メニューコンテンツのデザイン調整）」では、問題文の「以下のプレビューのように、メニューコンテンツのデザインを調整してください」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
