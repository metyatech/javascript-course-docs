...
<div class="wrap">
    <p class="content">
        ...
        Aliquam erat volutpat, suspendisse potenti, sed dignissim lacinia
        nunc.<br />
...
<Hint>
「もっと見る / 演習1（コンテンツの高さ制限）」では、問題文の「以下のプレビューと同じように、コンテンツの高さが110pxに制限されるようにしてください」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習2（フェードの追加）」では、問題文の「以下のプレビューと同じように、コンテンツの高さを適度に制限し、下部にフェードを重ねてくだ…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習3（開閉機能の作成）」では、問題文の「以下のプレビューと同じように、ボタンをクリックするとコンテンツが開閉するようにしてくださ…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習4（アニメーション化）」では、問題文の「以下のプレビューと同じように、コンテンツの開閉が滑らかにアニメーションするようにしてくだ…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習5（ボタンテキストの切り替え）」では、問題文の「以下のプレビューと同じように、開いているときは「閉じる」、閉じているときは「もっと見る」…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習-発展1（段階的に開く「もっと見る」）」では、問題文の「以下のプレビューと同じように、3段階で開く「もっと見る」を実装してください」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習-発展2（コンテンツの最後に「もっと見る」ボタンを配置）」では、問題文の「以下のプレビューと同じように、「もっと見る」ボタンをコンテンツの外ではなく、コンテンツ内…」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
...
<Hint>
「もっと見る / 演習-発展3（デザイン調整）」では、問題文の「以下のプレビューと同じような見た目に整えてください」を満たすために、問題文の条件と完成例で変わる値を先に分けて考えましょう。完成例の中で、問題文の条件に対応している行を先に見つけましょう。
</Hint>
